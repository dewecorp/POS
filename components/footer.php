...
<p>&copy; <?=date('Y')?> <?=e((store_info()['name'] ?? APP_NAME))?>.</p><div class="flex gap-3"><a href="<?=url('/admin/index')?>" class="hover:text-emerald-600">Dashboard</a><a href="<?=url('/kasir/index')?>" class="hover:text-emerald-600">Kasir</a></div>
</div>
</footer>
