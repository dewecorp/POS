...
<div class="rounded-2xl border bg-white p-4 shadow-sm"><h3 class="text-xs font-semibold mb-2">Kas Masuk/Keluar</h3><form method="POST" class="grid grid-cols-2 gap-2 mb-3"><input type="hidden" name="_csrf" value="<?=e(csrf_token())?>"><input type="hidden" name="act" value="cash"><select name="type" class="rounded-xl border px-2 py-2 text-xs"><option value="in">Masuk</option><option value="out">Keluar</option></select><input name="category" placeholder="Kategori" required class="rounded-xl border px-2 py-2 text-xs"><input name="amount" placeholder="Nominal" required class="rounded-xl border px-2 py-2 text-xs"><input name="description" placeholder="Keterangan" class="rounded-xl border px-2 py-2 text-xs"><button class="col-span-2 rounded-xl bg-emerald-600 py-2 text-white text-xs">Simpan Kas</button></form>
<form method="POST" enctype="multipart/form-data" class="border-t pt-3 space-y-2"><input type="hidden" name="_csrf" value="<?=e(csrf_token())?>"><input type="hidden" name="act" value="expense"><p class="text-xs font-semibold">Tambah Pengeluaran</p><input name="category" placeholder="Kategori (Listrik, ATK...)" required class="w-full rounded-xl border px-3 py-2 text-xs"><input name="amount" placeholder="Nominal" required class="w-full rounded-xl border px-3 py-2 text-xs"><input type="date" name="expense_date" value="<?=date('Y-m-d')?>" class="w-full rounded-xl border px-3 py-2 text-xs"><input name="description" placeholder="Keterangan" class="w-full rounded-xl border px-3 py-2 text-xs"><input type="file" name="proof" class="w-full rounded-xl border px-3 py-2 text-xs"><button class="w-full rounded-xl bg-amber-500 py-2 text-white text-xs">Simpan Pengeluaran</button></form>
</div>
</div>
