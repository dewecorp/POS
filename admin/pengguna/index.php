...
?>
<!DOCTYPE html><html lang="id"><head><title>Pengguna • <?=e(APP_NAME)?></title><?php include __DIR__.'/../../components/head.php'; ?></head>
...
<form method="GET" class="flex gap-2"><input name="q" value="<?=e($q)?>" placeholder="Cari nama/username/email" class="flex-1 rounded-xl border px-3 py-2 text-xs"><button class="rounded-xl border bg-white px-4 py-2 text-xs">Cari</button></form>
