...
<div class="flex justify-end"><a href="<?=APP_URL?>/kasir/index.php" class="rounded-full bg-emerald-600 px-4 py-1.5 text-xs font-medium text-white shadow-sm">Buka POS</a></div>
...
<section class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm"><p class="text-xs font-semibold mb-2">Aksi cepat</p><div class="grid grid-cols-2 gap-2 text-xs"><a href="<?=APP_URL?>/admin/produk/index.php" class="rounded-xl bg-emerald-50 px-3 py-2 text-center">Kelola Produk</a><a href="<?=APP_URL?>/admin/pembelian/index.php" class="rounded-xl bg-emerald-50 px-3 py-2 text-center">Pembelian</a><a href="<?=APP_URL?>/admin/stok/index.php" class="rounded-xl bg-amber-50 px-3 py-2 text-center">Stok Opname</a><a href="<?=APP_URL?>/admin/laporan/index.php" class="rounded-xl bg-sky-50 px-3 py-2 text-center">Laporan</a></div></section>
</div>
